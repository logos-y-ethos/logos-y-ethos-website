...
@section('content')
    ...
    <div class="module-container">
        ...
        <h5>Lista de Miembros del Comité Consultivo</h5>

        <a class="button add-button" href="{{ url('/admin/comite-consultivo/agregar') }}">
            Agregar
                ...
                @forelse ($members as $member)
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ url('/admin/comite-consultivo/editar/' . $member->id) }}">
...
<script>
    ...
    function deleteItem() {
        if (idToDelete >= 0) location.assign(`{{ url('/admin/comite-consultivo/borrar/') }}/${idToDelete}`);
    }
