    ...
    <main class="home-container">
        ...
        <section class="section-home-news" style="
            ...
            <div class="new-description">
                ...
                maxime dicta cumque explicabo ea beatae. Veniam eius quo eum error, corrupti aliquam esse
                exercitationem deleniti eveniet rerum.\n\nLorem ipsum dolor sit amet, consectetur
                adipisicing
                elit. Dolor accusantium consectetur, sed maxime dicta cumque explicabo ea beatae. Veniam
                eius
                quo eum error, corrupti aliquam esse exercitationem deleniti eveniet rerum.
            </div>
            <div class="new-link">
                <a href="#" class="button button-highlight">IR A LA PUBLICACIÓN</a>
            </div>
        </section>
        ...
        <section class="section-last-publications">
            ...
            <div class="section-publications-container">
                ...
                @foreach ($publications as $publication)
                    <article>
                        <div class="about">
                            <div>REVISTA N° {{ $publication->code }}</div>
                            <b>{{ $publication->title }}</b>
                            <div>
                                <img src="{{ asset('files' . $publication->cover) }}" alt="">
                            </div>
                            <a class="button button-gray" href="{{ url('/publicaciones/' . $publication->id) }}">
                                VER REVISTA
                            </a>
                        </div>
            ...
            <a href="{{ url('/publicaciones') }}"> Ver todas las publicaciones </a>
